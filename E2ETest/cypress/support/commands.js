...
function skapaIntygViaApi(fx,status, typ, theFill){
    ...
    //const dataToSend = JSON.stringify({"certificateType": intygTyp,"certificateTypeVersion": "1.0","patientId": patient.personnummerKompakt"personId": läkare,"unitId": vårdenhet,"status": intygStatus,"fillType": "MINIMAL"});
    //const dataToSend = JSON.stringify({"certificateType": "AG00213","certificateTypeVersion": "1.0","patientId": "191212121212","personId": "TSTNMT2321000156-DRAJ","unitId": "TSTNMT2321000156-ALVC","status": "LOCKED","fillType": "MINIMAL"});
...
function skapaUtkast(fx, intygstyp) {
    ...
    const vårdenhet = fx.vårdenhet;
    const webcertAdress = Cypress.env('webcertUrl') + "/services/create-draft-certificate/v3.0";
    expect(vårdpersonal).to.exist;
