      ...
      <div className="ic-page-header__inner">
        ...
        <div className="ic-page-header__item iu-mr-gutter ic-avatar-box">
          ...
          <div className="iu-lh-narrow">
            <p className=" ic-avatar-box__name">
              Arnold Johansson - Läkare <br /> Vårdgivare - Vårdenhet
            </p>
            <p className="iu-hide-md iu-hide-sm iu-display-flex">
              <a href="#" className="iu-link-divider-right iu-color-main">
                Om Webcert
              </a>
              <a href="#" className="iu-color-main">
                Logga ut
              </a>
            </p>
          </div>
