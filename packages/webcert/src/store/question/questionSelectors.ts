...
export const isSendingQuestion = (state: RootState): boolean => state.ui.uiQuestion.isSendingQuestion

export const isQuestionFunctionDisabled = (state: RootState): boolean => state.ui.uiQuestion.functionBlockers.length > 0
