...
export enum ErrorCode {
  ...
  SIGN_NETID_ERROR = 'SIGN_NETID_ERROR',
  INTYG_FROM_OTHER_VARDGIVARE_EXISTS = 'INTYG_FROM_OTHER_VARDGIVARE_EXISTS',
  INTYG_FROM_SAME_VARDGIVARE_EXISTS = 'INTYG_FROM_SAME_VARDGIVARE_EXISTS',
}
