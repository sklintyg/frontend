...
const Question: React.FC<QuestionProps> = ({ id, className }) => {
  ...
  const getQuestionComponent = (config: CertificateDataConfig, displayMandatory: boolean, readOnly: boolean) => {
    ...
    if (disabled) {
      return <QuestionHeading hideLabel={hideLabel} readOnly={question.readOnly} question={question} {...question.config} />
    }
    ...
    return (
      <>
        ...
        {<QuestionHeading hideLabel={hideLabel} readOnly={question.readOnly} question={question} {...question.config} />}
      </>
    )
  }
