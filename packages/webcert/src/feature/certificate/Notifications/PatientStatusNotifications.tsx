...
const PatientStatusNotifications: React.FC = () => {
  ...
  return (
    <>
      {!hasNoStatuses && (
        <Wrapper>
          {isPatientDeceased && <PatientStatusNotification type={'info'} title={'Patienten är avliden'} status={isPatientDeceased} />}
          {isPatientProtectedPerson && (
            <PatientStatusNotificationWithModal
              ...
              <p>
                Att en patient har skyddade personuppgifter betyder att Skatteverket har bedömt att patientens personuppgifter är extra
                viktiga att skydda. Det finns speciella riktlinjer för hur personuppgifter för de invånarna ska hanteras. I Webcert innebär
                det att:
                <ul>
                  <li>
                    Du som användare av Webcert ska behandla personuppgifterna med försiktighet. Samtliga personuppgifter rörande patienten
                    är skyddsvärda.
                  </li>
                  <li>
                    Endast läkare och tandläkare kan skapa intyg för dessa patienter. Endast läkare och tandläkare, inloggade på den
                    vårdenhet intyget utfärdades på, kan se och hantera intyget.
                  </li>
                  <li>En symbol visas i alla vyer i gränssnittet som indikerar att patienten har skyddade personuppgifter.</li>
                  <li>
                    Endast ett urval av intygstyper kan utfärdas för patienten med skyddade personuppgifter. Det beror på att det krävs
                    särskild hantering av deras personuppgifter i Webcert och hos mottagaren av intyget.
                  </li>
                </ul>
              </p>
            </PatientStatusNotificationWithModal>
          ...
          {isPatientTestIndicated && (
            <PatientStatusNotificationWithModal
              ...
              <p>
                En valideringsperson är en fingerad person som används i syfte att validera funktion, felsöka och säkerställa kvalitet i
                tjänsten. Intyg utfärdade på valideringsperson kan inte skickas till intygsmottagare. De kommer inte heller visas i
                Intygsstatistik, Rehabstöd eller i Mina intyg.{' '}
              </p>
            </PatientStatusNotificationWithModal>
          )}
          {showReserveIdStatus && (
            <PatientStatusNotificationWithModal
              ...
              title={
                'Patienten har samordningsnummer kopplat till reservnummer: ' + (patient && previousPatientId ? patient.personId.id : '')
              }
