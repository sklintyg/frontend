import { IDSFooter1177, IDSIconArrow, IDSIconExternal, IDSLink } from '@inera/ids-react'
...
export function LayoutFooter({ hasSession }: { hasSession: boolean }) {
  return (
    <IDSFooter1177 headline="1177" subheadline="– tryggt om din hälsa och vård" cols={2} className="print:hidden">
