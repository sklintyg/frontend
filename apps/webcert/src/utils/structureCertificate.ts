import { sortByIndex } from '@frontend/common'
import { CertificateData, CertificateDataElement, CertificateDataElementStyleEnum, ConfigTypes } from '@frontend/common/types'
