...
export const getExpressionResult = (expression: string, value: ValueType): unknown =>
...
export const validateExpression = (expression: string, value: ValueType): boolean =>
  expression === '1' || expression === '0' ? expression === '1' : Boolean(getExpressionResult(expression, value))
