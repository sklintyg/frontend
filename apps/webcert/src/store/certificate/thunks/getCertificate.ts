...
import { getCertificateCompleted, getCertificateEvents, validateCertificate } from '../certificateActions'
import { hideSpinner, showSpinner, updateCertificate, updateCertificateSignStatus } from '../certificateSlice'
