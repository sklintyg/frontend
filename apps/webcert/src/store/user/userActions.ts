...
const setUserPreferenceError = createAction<string>(`${USER} Set user preference error`)
...
const cancelLogoutError = createAction<string>(`${USER} Cancel logout error`)
...
const triggerLogoutError = createAction<string>(`${USER} Trigger logout error`)
...
const triggerFakeLogoutError = createAction<string>(`${USER} Trigger fake logout error`)
...
const triggerLogoutNowError = createAction<string>(`${USER} Trigger logout now error`)
...
const setUnitError = createAction<string>(`${USER} Set unit error`)
