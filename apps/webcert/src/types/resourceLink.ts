...
export enum ResourceLinkType {
  ...
  ACCESS_EDIT_PRIVATE_PRACTITIONER = 'ACCESS_EDIT_PRIVATE_PRACTITIONER',
  ACCESS_QUESTION_LIST = 'ACCESS_QUESTION_LIST',
  ACCESS_REGISTER_PRIVATE_PRACTITIONER = 'ACCESS_REGISTER_PRIVATE_PRACTITIONER',
  ...
  NOT_AUTHORIZED_PRIVATE_PRACTITIONER = 'NOT_AUTHORIZED_PRIVATE_PRACTITIONER',
