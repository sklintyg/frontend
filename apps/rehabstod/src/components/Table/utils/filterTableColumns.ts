...
export const filterPatientViewColumns = (name: string) => name === 'Namn' || name === 'Personnummer' || name === 'Kön' || name === 'Ålder'

export const filterPersonalInformation = (name: string) => name === 'Namn' || name === 'Personnummer'
...
export const filterTableColumns = (
  ...
  columns
    ...
    .filter(({ name }) => !(!showPersonalInformation && filterPersonalInformation(name)))
