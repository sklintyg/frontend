...
export function ReadMoreAboutDialog({ open, onOpenChange, children }: {
  open: boolean
  children: ReactNode
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange} dismissible headline="Vad kan du göra i Intyg">
      ...
      <ul className="list-disc pl-10 mb-5">
        ...
        <li>En del intyg går inte att skicka här. Till exempel intyg till arbetsgivare. Dessa kan du i stället skriva ut eller spara som dokument.</li>
      </ul>
