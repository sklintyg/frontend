import { CertificateListIssuer, CertificateListUnit } from '../../../../schema/certificateList.schema'

export function CertificateCardInfo({ issuer, unit, id }: { issuer: CertificateListIssuer; unit: CertificateListUnit; id: string }) {
  return (
